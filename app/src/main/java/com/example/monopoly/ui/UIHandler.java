...
public class UIHandler extends Handler {
    ...
    public void handleMessage(@NonNull Message msg) {
        ...
        switch (type) {
            ...
            case "initializePlayerBottomRight":
                ...
                //imageView.setImageResource(R.drawable.layerlist_for_gameboard);
                //imageView.invalidate();

                //goLeftBottom(layerDrawable,imageView);
    ...
    public void goLeftBottom(LayerDrawable layerDrawable, ImageView imageView){
